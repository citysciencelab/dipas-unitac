...
use Drupal\dipas\Services\EntityServicesInterface;
 ...
 * @group dipas
 */
abstract class ServicesUnitTestBase extends UnitTestCase {
  ...
  /**
   * Prepares consistent test data for all tests.
   *
   * @return array
      ...
      'entity_types' => [
        'node' => [
          ...
          'fields' => [
            ...
            'field_node_entity_reference_taxonomy_rubric' => [
              'field_type' => 'entity_reference',
              'label' => 'Entity Reference: taxonomy:tags',
              'handler' => 'default:taxonomy_term',
              'handler_settings' => ['target_bundles' => ['rubrics' => 'rubrics']],
              'field_storage_definition' => $singlevalueFieldStorageDefinition,
            ],
          ],
          'keys' => [
        ...
        'media' => [
          ...
          'fields' => [
            ...
            'field_media_entity_reference_taxonomy_rubrics' => [
              'field_type' => 'entity_reference',
              'label' => 'Entity Reference: taxonomy:rubrics',
              'handler' => 'default:taxonomy_term',
              'handler_settings' => ['target_bundles' => ['rubrics' => 'rubrics']],
