...
use Drupal\dipas\PluginSystem\PDSResponsePluginInterface;
...
/**
 * Class PDSResponseBase.
 *
 * @package Drupal\dipas\Plugin\PDSResponse
 */
abstract class PDSResponseBase implements PDSResponsePluginInterface {
  ...
  final public function getCacheTags() {
    $commonCacheTags = ['dipasPDSEndpoint', "dipasPDSEndpoint:{$this->pluginDefinition['id']}"];
